...
import { getAllProfiles } from "../../lib/services/profileServices";
import { getPrayerRequest } from "../../lib/services/prayerServices";
            ...
            <div className={styles.heroContent}>
              <div>
                ...
                <p className={styles.heroSub}>
                  Kabulengwa English SDA Church Kampala â€” your leadership
          ...
          <div className={styles.statCardsGrid}>
            <div className={styles.statCardItem}>
              <Tile className={`${styles.statTile} ${styles.accentTile}`}>
                ...
                <Link href="/dashboard/programs" className={styles.cardLink}>
                  <Button
                    kind="secondary"
                    size="sm"
            ...
            <div className={styles.statCardItem}>
              <Tile className={styles.statTile}>
                ...
                <Link href="/dashboard/members" className={styles.cardLink}>
                  <Button
                    kind="secondary"
                    size="sm"
                    renderIcon={ArrowRight}
            ...
            <div className={styles.statCardItem}>
              <Tile className={styles.statTile}>
                ...
                <Link href="/dashboard/prayer" className={styles.cardLink}>
                  <Button
                    kind="secondary"
                    size="sm"
                    renderIcon={ArrowRight}
            ...
            <div className={styles.statCardItem}>
              <Tile className={styles.statTile}>
                ...
                <Link href="/dashboard/attendance" className={styles.cardLink}>
                  <Button
                    kind="secondary"
                    size="sm"
                    renderIcon={ArrowRight}
