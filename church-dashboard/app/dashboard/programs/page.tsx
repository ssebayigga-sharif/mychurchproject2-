...
import {
  ...
  getPrograms,
  updateProgram,
} from "../../../lib/services/programServices";
import { ProgramModal } from "../../../components/programmes/ProgramModal";
...
export default function ProgramsPage() {
  ...
  const parseDate = (dateStr: string) => {
    try {
      ...
      if (isNaN(d.getTime())) return { month: "â€”", day: "â€”" };
      return {
        month: d.toLocaleDateString("en-US", { month: "short" }).toUpperCase(),
        day: d.getDate(),
      };
    } catch {
      return { month: "â€”", day: "â€”" };
    }
  };
