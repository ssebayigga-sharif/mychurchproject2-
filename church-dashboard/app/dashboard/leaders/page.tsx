...
import {
  ...
  addLeader,
  removeLeader,
} from "../../../lib/services/leadersServices";
...
import styles from "../../../styles/modules/leaders.module.scss";

const POSITIONS: LeaderPosition[] = [
  "Elder",
  "Deacon",
  "Deaconess",
  "Treasurer",
          ...
          <div className={styles.header}>
            <div>
              ...
              <p className={styles.subtitle}>
                Manage and assign ecclesiastical roles
              </p>
            </div>
            <Button
              renderIcon={Add}
      ...
      >
        <Stack gap={6}>
          <p className={styles.modalText}>
            Select a member from the registry and assign them to a leadership
            role.
          </p>
          <Select
            id="member-select"
          ...
          <Select
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                position: e.target.value as LeaderPosition,
              })
            }
          >
            {POSITIONS.map((p) => (
          ...
          <Select
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                department: (e.target.value as MemberDepartment) || undefined,
              })
            }
          >
